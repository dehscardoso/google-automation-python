...
# and assume that it's only used to indicate a comment. We also want to treat repetitive hash 
# marks (##), (###), etc., as a single comment indicator, to be replaced with just (//) 
# and not (#//) or (//#). Fill in the parameters of the substitution method to complete 
# this function: 
