...
# using attributes associated with the object. The values of these attributes can be 
# easily changed at the object level.  The following code illustrates a famous quote 
# by George Bernard Shaw, using objects to represent people. Fill in the blanks to make 
